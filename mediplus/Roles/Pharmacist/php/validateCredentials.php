<?php
  ...
  function storeAdminData() {
    ...
    if($con) {
      ...
      $query = "INSERT INTO pharmacy (PHARMACY_NAME, ADDRESS, EMAIL, CONTACT_NUMBER, USERNAME, PASSWORD, IS_LOGGED_IN) VALUES('$pharmacy_name', '$address', '$email', '$contact_number', '$username', '$password', 'false')";
      $result = mysqli_query($con, $query);
  ...
  function updateAdminInfo() {
    ...
    if($con) {
      ...
      $query = "UPDATE pharmacy SET PHARMACY_NAME = '$pharmacy_name', ADDRESS = '$address', EMAIL = '$email', CONTACT_NUMBER = '$contact_number', USERNAME = '$username'";
      $result = mysqli_query($con, $query);
